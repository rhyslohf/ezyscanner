angular.module('ezyScannerApp')
  .directive('camera', function ($q, ExifRestorer) {
    ...
    return {
      restrict: 'E',
      template: '<input type="file" capture="camera" accept="image/*" id="camera" class="d-none" style="visibility: hidden;" />' +
      '<img class="img-fluid pointer" src="camera.png" ng-click="takePhoto()"><div class="clearfix"></div>',
