...
var compressImageBuffer = function(buffer) {
    console.log("Compressing Image Buffer")
    console.log("Buffer size "+Math.round(buffer.length/1024)+"kb")
    return new Promise(function(resolve, reject) {
        sharp(buffer)
...
var base64ToPlate = function(base64) {
    ...
    console.log("Base64 size "+Math.round(base64.length/1333)+"kb")

    return new Promise(function(resolve, reject) {
        var secret_key = process.env.SECRET_KEY || 'sk_8af55fbf65cf9bcefd219b6a';
